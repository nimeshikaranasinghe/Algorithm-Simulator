...
//=========================CLEAR PROGRASS DOTS=============================================//
        ...
        public void run()                                   
        {
            try
            {
              ...
              //=================START OF SORTING=======================================//
                ...
                int arrowStart = 50;                                          //VARIABLE TO SOTRE STARTING POINT OF THE GREEN ARROW               
                int next = 60;                                              //DEFINES X DIRECTION ON EACH STEP FOR GREEN ARROWS AND KEY LABEL
                
                for (int j=1;  j<noOfUserInputs;  j++){
                    ...
                    lbl_line1.setBackground(new java.awt.Color(21,101,192));        //CHANGE THE COLOR OF LINE INTO PREVIOUS COLOR
                    
                    //--DISPLAY KEY VALUE
                    lbl_line2.setBackground(new java.awt.Color(0,0,102));           //HIGHLIGHT THE RELATED ALOGITHM LINE 2
                    int key = array[j];                                             //GET THE KEY VALUE TO A VARIABLE
                    lbl_key.setText(Integer.toString(key));                         //ASSIGN KEY VALUE TO KEY VALUE LABEL
                    labelsOut[j].setBackground(new java.awt.Color(255,65,129));      //SHOW THE ELEMENT THAT IS GOING TO BE THE KEY
                    sortThreadAscen.sleep(1000);
                    lbl_key.setVisible(true);                                        //MAKE KEY LABEL TO VISIBLE
                    lbl_k.setVisible(true);                                        
                    labelsOut[j].setBackground(new java.awt.Color(0,0,40));          //REPAINT THE ELEMENT THAT IS GOING TO BE THE KEY TO PREVIOUS COLOUR 
                    sortThreadAscen.sleep(1000);                
                    lbl_line2.setBackground(new java.awt.Color(21,101,192));        //CHANGE THE COLOR OF LINE INTO PREVIOUS COLOR
                    
                    int i = j-1;
                    lbl_line3.setBackground(new java.awt.Color(0,0,102));           //HIGHLIGHT THE RELATED ALOGITHM LINE 3
                    sortThreadAscen.sleep(1500);
                    lbl_line3.setBackground(new java.awt.Color(21,101,192));        //CHANGE THE COLOR OF LINE INTO PREVIOUS COLOR
                    
                    int keyGoFrom = keyStart;                                   //VARIABLE TO SOTRE STARTING POINT INSIDE WHILE OF THE KEY LABEL AND KEY ASSIGN ARROW 
                    int arrowGoFrom = arrowStart;                               //VARIABLE TO SOTRE STARTING POINT INSIDE WHILE OF THE GREEN ARROW 
                    ...
                    while( i>=0 && array[i] > key )
                    {
                        ...
                        lbl_tf.setText("TRUE");                                             //DISPLAY WHETHER THE 4TH LINE IS TRUE OR FLASE
                        lbl_tf.setVisible(true);
                    
                        //--MAKE SWAP PANEL VISIBLE AND DISPALY RELEVANT VALUES
                        pnl_show.setVisible(true);                              
                        lbl_iIndex.setText(Integer.toString(i));                        //DISPLAY i TH INDEX    
                        lbl_iValue.setText(labelsOut[i].getText());                     //DISPLAY array[i] VALUE                    
                        lbl_keyValue.setText(Integer.toString(key));                    //DISPLAY KEY VALUE     
                        lbl_ii.setText(Integer.toString(i+1));                          //DISPLAY i+1 TH INDEX  
                        lbl_i.setText(Integer.toString(i));                             //DISPLAY i TH INDEX  
                        ...
                        lbl_line5.setBackground(new java.awt.Color(0,0,102));               //HIGHLIGHT THE RELATED ALOGITHM LINE 5 
                        lbl_arrow.setVisible(true);                                     //MAKE GREEN ARROW VISIBLE
                        sortThreadAscen.sleep(1000);
                        array[i+1] = array[i];                                          //ASSIGN i iNDEX VALUE TO i+1 INDEX VALUE 
                        labelsOut[i+1].setText(labelsOut[i].getText());
                        sortThreadAscen.sleep(1500);
                        lbl_line5.setBackground(new java.awt.Color(21,101,192));       //CHANGE THE COLOR OF LINE INTO PREVIOUS COLOR
                        lbl_arrow.setVisible(false);
                        
                        lbl_line6.setBackground(new java.awt.Color(0,0,102));           //HIGHLIGHT THE RELATED ALOGITHM LINE 6
                        sortThreadAscen.sleep(1300);
                        lbl_line6.setBackground(new java.awt.Color(21,101,192));        //CHANGE THE COLOR OF LINE INTO PREVIOUS COLOR

                        lbl_tf.setVisible(false);
                        
                        i=i-1;                                                          //DECREASE i VALUE
                ...
                //---WHAT TO DO IF THE WHILE CONDITION IS FALSE
                    ...
                    lbl_algoSign.setBackground(new java.awt.Color(0,0,102));                             
                    lbl_tf.setBackground(new java.awt.Color(0,0,102));
                    lbl_tf.setText("FALSE");                                             //DISPLAY WHETHER THE 4TH LINE IS TRUE OR FLASE
                    lbl_tf.setVisible(true);

                    //--MAKE SWAP PANEL VISIBLE AND DISPALY RELEVANT VALUES
                    pnl_show.setVisible(true);                              
                    lbl_iIndex.setText(Integer.toString(i));                        //DISPLAY i TH INDEX    
                    lbl_iValue.setText(labelsOut[i+1].getText());                     //DISPLAY array[i] VALUE                    
                    lbl_keyValue.setText(Integer.toString(key));                    //DISPLAY KEY VALUE     
                    lbl_ii.setText(Integer.toString(i+1));                          //DISPLAY i+1 TH INDEX  
                    lbl_i.setText(Integer.toString(i));                             //DISPLAY i TH INDEX  
                    sortThreadAscen.sleep(1800);
                    ...
                    lbl_line7.setBackground(new java.awt.Color(0,0,102));               //HIGHLIGHT THE RELATED ALOGITHM LINE 7 
                    lbl_keyAssign.setVisible(true);                             //MALE KEY ASSIGN ARROW VALUE VISIBLE
                    array[i+1] = key;
                    sortThreadAscen.sleep(1000);
                    labelsOut[i+1].setText(Integer.toString(key));
                    sortThreadAscen.sleep(1800);
                    lbl_line7.setBackground(new java.awt.Color(21,101,192));       //CHANGE THE COLOR OF LINE INTO PREVIOUS COLOR
                    
                    lbl_keyAssign.setVisible(false);                            //DISAPERE KEY VALUE LABEL
                    lbl_key.setVisible(false);
                    lbl_k.setVisible(false);
                    lbl_tf.setVisible(false);
                    pnl_show.setVisible(false);                             //MAKE pnl_show PANEL INVISIBLE
                    
                    keyStart = keyStart + next;                                 //DECIDE FROM WHERE KEY LABEL START FROM NEXT for LOOP
                    arrowStart = arrowStart + next;                             //DECIDE FROM WHERE GREEN ARROW START FROM NEXT for LOOP
    ...
    private void initComponents() {
        ...
        pnl_insertionAlgo = new javax.swing.JPanel();
        ...
        lbl_iValue = new javax.swing.JLabel();
        lbl_keyValue = new javax.swing.JLabel();
        ...
        lbl_keyAssign = new javax.swing.JLabel();
        ...
        pnl_insertionAlgo.setBackground(new java.awt.Color(21, 101, 192));
        pnl_insertionAlgo.setLayout(null);
        ...
        pnl_insertionAlgo.add(lbl_tf);
        lbl_tf.setBounds(290, 185, 60, 30);
        ...
        pnl_insertionAlgo.add(lbl_algoSign);
        lbl_algoSign.setBounds(240, 180, 20, 38);
        ...
        lbl_line1.setText("1.     for (int j=1;  j<size;  j++)");
        lbl_line1.setOpaque(true);
        pnl_insertionAlgo.add(lbl_line1);
        lbl_line1.setBounds(12, 60, 343, 38);
        ...
        lbl_line2.setText("2.          int key = array[j]");
        lbl_line2.setOpaque(true);
        pnl_insertionAlgo.add(lbl_line2);
        lbl_line2.setBounds(12, 100, 343, 38);
        ...
        lbl_line3.setText("3.          int i = j-1 ");
        lbl_line3.setOpaque(true);
        pnl_insertionAlgo.add(lbl_line3);
        lbl_line3.setBounds(12, 140, 343, 38);
        ...
        lbl_line4.setText("4.          while (i>=0  AND  array[i] > key) ");
        lbl_line4.setOpaque(true);
        pnl_insertionAlgo.add(lbl_line4);
        lbl_line4.setBounds(12, 180, 343, 38);
        ...
        lbl_line5.setText("5.                        array[i+1] = array[i] ");
        lbl_line5.setOpaque(true);
        pnl_insertionAlgo.add(lbl_line5);
        lbl_line5.setBounds(12, 220, 343, 38);
        ...
        lbl_line6.setText("6.                        i = i-1");
        lbl_line6.setOpaque(true);
        pnl_insertionAlgo.add(lbl_line6);
        lbl_line6.setBounds(12, 260, 343, 38);
        ...
        lbl_line7.setText("7.          array[i+1] = key");
        lbl_line7.setOpaque(true);
        pnl_insertionAlgo.add(lbl_line7);
        lbl_line7.setBounds(12, 300, 343, 38);

        pnl_algorithm.add(pnl_insertionAlgo);
        pnl_insertionAlgo.setBounds(0, 50, 360, 515);
        ...
        lbl_finishI.setBounds(670, 220, 30, 30);
        ...
        lbl_finish1.setBounds(700, 220, 10, 30);
        ...
        lbl_finish2.setBounds(710, 220, 10, 30);
        ...
        lbl_finish3.setBounds(720, 220, 10, 30);
        ...
        lbl_finish4.setBounds(730, 220, 10, 30);
        ...
        lbl_finish5.setBounds(740, 220, 10, 30);
        ...
        lbl_finish.setBounds(520, 220, 230, 30);

        lbl_key.setBackground(new java.awt.Color(255, 65, 129));
        lbl_key.setFont(new java.awt.Font("Leelawadee UI", 0, 22)); // NOI18N
        ...
        pnl_sorting.add(lbl_key);
        lbl_key.setBounds(90, 140, 55, 50);

        pnl_show.setBackground(new java.awt.Color(25, 118, 210));
        pnl_show.setLayout(null);

        lbl_iValue.setBackground(new java.awt.Color(25, 118, 210));
        lbl_iValue.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 20)); // NOI18N
        lbl_iValue.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_iValue.setText("8888");
        lbl_iValue.setOpaque(true);
        pnl_show.add(lbl_iValue);
        lbl_iValue.setBounds(200, 0, 50, 30);

        lbl_keyValue.setBackground(new java.awt.Color(25, 118, 210));
        lbl_keyValue.setFont(new java.awt.Font("Leelawadee UI Semilight", 1, 20)); // NOI18N
        lbl_keyValue.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_keyValue.setText("8888");
        lbl_keyValue.setOpaque(true);
        pnl_show.add(lbl_keyValue);
        lbl_keyValue.setBounds(280, 0, 50, 30);
        ...
        lbl_sign.setBounds(251, -2, 30, 30);

        lbl_iIndex.setBackground(new java.awt.Color(25, 118, 210));
        lbl_iIndex.setFont(new java.awt.Font("Leelawadee UI Semilight", 0, 20)); // NOI18N
        lbl_iIndex.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_iIndex.setText("i");
        lbl_iIndex.setOpaque(true);
        pnl_show.add(lbl_iIndex);
        lbl_iIndex.setBounds(60, 0, 30, 30);

        lbl_and.setBackground(new java.awt.Color(25, 118, 210));
        lbl_and.setFont(new java.awt.Font("Leelawadee UI Semilight", 0, 20)); // NOI18N
        lbl_and.setForeground(new java.awt.Color(173, 173, 173));
        lbl_and.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_and.setText("AND");
        lbl_and.setOpaque(true);
        pnl_show.add(lbl_and);
        lbl_and.setBounds(143, 0, 50, 30);

        lbl_ii.setBackground(new java.awt.Color(25, 118, 210));
        lbl_ii.setFont(new java.awt.Font("Leelawadee UI Semilight", 0, 20)); // NOI18N
        lbl_ii.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_ii.setText("11");
        lbl_ii.setOpaque(true);
        pnl_show.add(lbl_ii);
        lbl_ii.setBounds(126, 32, 19, 30);

        lbl_i.setBackground(new java.awt.Color(25, 118, 210));
        lbl_i.setFont(new java.awt.Font("Leelawadee UI Semilight", 0, 20)); // NOI18N
        lbl_i.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_i.setText("11");
        lbl_i.setOpaque(true);
        pnl_show.add(lbl_i);
        lbl_i.setBounds(220, 32, 19, 30);
        ...
        lbl_swap5.setText("do  array[  i  ] = array[  i  ] ");
        lbl_swap5.setOpaque(true);
        pnl_show.add(lbl_swap5);
        lbl_swap5.setBounds(50, 32, 240, 30);
        ...
        lbl_swap6.setText("while  (   i  >= 0    AND                               )");
        lbl_swap6.setOpaque(true);
        pnl_show.add(lbl_swap6);
        lbl_swap6.setBounds(0, 0, 370, 30);

        pnl_sorting.add(pnl_show);
        pnl_show.setBounds(80, 210, 410, 70);

        lbl_arrow.setIcon(new javax.swing.ImageIcon(getClass().getResource("/daa/drawing_2.png"))); // NOI18N
        pnl_sorting.add(lbl_arrow);
        lbl_arrow.setBounds(50, 80, 90, 50);

        lbl_keyAssign.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_keyAssign.setIcon(new javax.swing.ImageIcon(getClass().getResource("/daa/drawing_arrow.png"))); // NOI18N
        lbl_keyAssign.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        pnl_sorting.add(lbl_keyAssign);
        lbl_keyAssign.setBounds(90, 85, 55, 50);
        ...
        lbl_k.setFont(new java.awt.Font("Nirmala UI Semilight", 0, 14)); // NOI18N
        lbl_k.setForeground(new java.awt.Color(255, 255, 255));
        lbl_k.setText("Key=");
        pnl_sorting.add(lbl_k);
        lbl_k.setBounds(0, 150, 40, 30);
    ...
    private void btn_ascActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ascActionPerformed
        ...
        //sortThreadAscen.start();                 //START THE THREAD
        if(!sortThreadAscen.isAlive())
            sortThreadAscen.start();                 //START THE THREAD
        else
    ...
    private void btn_dscActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_dscActionPerformed
        ...
        //sortThreadDescen.start();                             //START THE THREAD
        if(!sortThreadDescen.isAlive())
            sortThreadDescen.start();                 //START THE THREAD
        else
            System.out.println("thread still running");
    ...
    private javax.swing.JLabel lbl_iValue;
    private javax.swing.JLabel lbl_ii;
    private javax.swing.JLabel lbl_k;
    private javax.swing.JLabel lbl_key;
    private javax.swing.JLabel lbl_keyAssign;
    private javax.swing.JLabel lbl_keyValue;
    ...
    private javax.swing.JPanel pnl_insertionAlgo;
